...
update_stocks_table([dey_paye_code, dey_scnd_code])
```
...
![اطلاعات ذخیره شده بانک دی در دیتابیس](img/database-stocks-dey-bank.png)
...
for i in range(1001):
    time.sleep(1)    
    print("hi", " "*100, end="\r", flush=True)
    print(i,  " "*100, end="\r", flush=True)
